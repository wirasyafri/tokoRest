...
<section class="main-section paddind" id="toko" style="background-image: url(<?php echo base_url()."images/shopping_area_in_beijing-wallpaper-1920x1080.jpg"?>); "><!--main-section-start-->
	<div class="container">
    	
        <?php $this->load->view('pembelian/tampil_toko'); ?>
	</div>
