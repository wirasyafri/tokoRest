	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse ">
			<ul class="nav navbar-nav">
				<li><a href="<?php echo site_url();?>/admin"><i class="glyphicon glyphicon-home"></i> Data Game </a></li>
				<li><a href="<?php echo site_url();?>/admin/Create"><i class="glyphicon glyphicon-info-sign"></i>Tambah Game</a></li>
