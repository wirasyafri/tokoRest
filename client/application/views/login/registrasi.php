...
<head>
<title>Shop Register FirWirVick</title>
...
<?php echo form_open('login/register'); ?>
	<div class="padding-all">
		<div class="header">
			<h1><img src="<?=base_url()?>/images/5.png" alt=" "> Shoping Register Form</h1>
		</div>
		...
		<div class="design-w3l">
			<div class="mail-form-agile">
				<form action="#" method="post">
					...
					<input type="text" name="telp" placeholder="telp" pattern="[0-9]{1,}" required/>
		...
		<div class="footer">
		<p>Sudah punya akun ?? YUK <a href="<?php echo site_url();?>/login" >Login </a> dulu</p>
