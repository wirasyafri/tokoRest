	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse ">
			<ul class="nav navbar-nav">
				<li><a href="<?php echo site_url();?>/pegawai"><i class="glyphicon glyphicon-home"></i> Data Game </a></li>
				<li><a href="<?php echo site_url();?>/pegawai/toko"><i class="glyphicon glyphicon-info-sign"></i>Toko</a></li>
				<!-- <li><a href="index.php/tugasp3/contact"><i class="glyphicon glyphicon-phone"></i>contact</a></li> -->
				<li><a href="<?=site_url();?>/cetak">Cetak</a></li>

					<li>
						<a href="<?php echo site_url();?>/login/logout"><i class="glyphicon glyphicon-log-out"></i>logout</a>
					</li>
					
					<li>
						<a > HAI <?php $session_data =$this->session->userdata('logged_in');
						$data['username']=$session_data['username']; 
						echo 		$data['username'];				?></a>
					</li>
					<li>
						<a > uang <?php $session_data =$this->session->userdata('logged_in');
						$data['uang']=$session_data['uang'];
						echo 		$data['uang'];				?></a>
					</li>
				<!-- <li><a href="#">, <?php $session_data =$this->session->userdata('logged_in');
				// $data['uang']=$session_data['uang']; 
// echo 		$data['uang'];
				?></a></li> -->
